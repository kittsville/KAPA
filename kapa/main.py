...
def kapa(
    ...
    antibody_generator,   # Function to generate fresh antibodies (to replaced killed ones)
    ...
    for g in xrange(generations):
        ...
        for antigen_key, antigen in enumerate(antigens):
            ...
            if num_kill_antibodies > 0:
                ...
                antibodies = antibodies + [antibody_generator() for i in range(num_kill_antibodies)]
